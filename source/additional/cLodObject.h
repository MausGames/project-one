...
public:
    ...
    inline void DefineModelHigh(const coreHashString& sName)  {m_pModelHigh = Core::Manager::Resource->Get(sName);}
    ...
    inline void DefineModelLow (const coreHashString& sName)  {m_pModelLow  = Core::Manager::Resource->Get(sName); this->coreObject3D::DefineModel(m_pModelLow);}
