...
cGlow::cGlow()noexcept
{
    ...
    m_iFrameBuffer.Create(g_vGameResolution * GLOW_SCALE_FACTOR, CORE_FRAMEBUFFER_CREATE_NORMAL);

    // create blur frame buffers
    m_aiBlurStage[0].AttachTargetTexture(CORE_FRAMEBUFFER_TARGET_COLOR, 0, CORE_TEXTURE_SPEC_RGB);
    m_aiBlurStage[0].Create(g_vGameResolution * GLOW_SCALE_FACTOR, CORE_FRAMEBUFFER_CREATE_NORMAL);
    m_aiBlurStage[1].AttachTargetTexture(CORE_FRAMEBUFFER_TARGET_COLOR, 0, CORE_TEXTURE_SPEC_RGB);
    m_aiBlurStage[1].Create(g_vGameResolution * GLOW_SCALE_FACTOR, CORE_FRAMEBUFFER_CREATE_NORMAL);
