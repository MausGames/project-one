...
STATIC_ASSERT(INPUT_KEYS_ACTION <= BITSOF(coreUint16))
...
#define DEFAULT_JOYSTICK_ACTION(n)     (((n) == 0u) ? SDL_GAMEPAD_BUTTON_SOUTH : (((n) == 1u) ? SDL_GAMEPAD_BUTTON_LEFT_SHOULDER : (((n) == 2u) ? SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER : ((n) == 3u) ? SDL_GAMEPAD_BUTTON_NORTH : ((n) == 4u) ? SDL_GAMEPAD_BUTTON_WEST : ((n) == 5u) ? SDL_GAMEPAD_BUTTON_SOUTH : ((n) == 6u) ? SDL_GAMEPAD_BUTTON_EAST : ((n) == 7u) ? SDL_GAMEPAD_BUTTON_START : ((n) == 8u) ? SDL_GAMEPAD_BUTTON_EAST : INPUT_KEY_INVALID)))
