...
// vertex attributes
attribute float v_v1Height;      // vertex height (full position is deduced from the vertex-ID)
...
void VertexMain()
{
    ...
    vec3  v3NewPosition = vec3(vec2(i2Index - ivec2(c_i1Size/2)) * c_v1Detail, v_v1Height);
