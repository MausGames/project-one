...
const coreChar* const CoreApp::Settings::Version                    = "1.0.1";
...
void CoreApp::Setup()
{
    ...
    Core::Manager::Resource->Load<coreModel>  ("ship_boss_dharuk_boomerang.md3",         CORE_RESOURCE_UPDATE_AUTO,   "data/models/ship_boss_dharuk_boomerang.md3");
