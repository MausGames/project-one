...
void UnusedWaves()
{
    ...
    STAGE_MAIN({TAKE_ALWAYS})
    {
        ...
        STAGE_GET_START(2u)
            STAGE_GET_VEC2(vLastPosition, vLastPosition = g_pGame->GetPlayer(0u)->GetPosition().xy()) // TODO: coop 
        STAGE_GET_END
        ...
        STAGE_FOREACH_ENEMY(pSquad1, pEnemy, i)
        {
            ...
            {
                vLastPosition = g_pGame->GetPlayer(0u)->GetPosition().xy(); // TODO: coop 
...
/*
        ...
        if(STAGE_TICK_LIFETIME(5.0f, 0.0f))
        {
            ...
            {
                const coreVector2 vShift = coreVector2::Direction(DEG_TO_RAD(I_TO_F(j) * 45.0f)); // TODO: StepRotated45 (or X)
