...
// ****************************************************************
// icon codes (UTF-8)
#define ICON_U8(x)        (r_cast<const coreChar*>(x))
#define ICON_CHECK        (ICON_U8(u8"\uF00C"))
#define ICON_TIMES        (ICON_U8(u8"\uF00D"))
#define ICON_POWER_OFF    (ICON_U8(u8"\uF011"))
#define ICON_REFRESH      (ICON_U8(u8"\uF021"))
#define ICON_ARROW_LEFT   (ICON_U8(u8"\uF060"))
#define ICON_ARROW_RIGHT  (ICON_U8(u8"\uF061"))
#define ICON_ARROW_UP     (ICON_U8(u8"\uF062"))
#define ICON_ARROW_DOWN   (ICON_U8(u8"\uF063"))
#define ICON_SHARE        (ICON_U8(u8"\uF064"))
#define ICON_COGS         (ICON_U8(u8"\uF085"))
#define ICON_CARET_DOWN   (ICON_U8(u8"\uF0D7"))
#define ICON_CARET_UP     (ICON_U8(u8"\uF0D8"))
#define ICON_CARET_LEFT   (ICON_U8(u8"\uF0D9"))
#define ICON_CARET_RIGHT  (ICON_U8(u8"\uF0DA"))
#define ICON_PAUSE_CIRCLE (ICON_U8(u8"\uF28B"))
#define ICON_UNDO_ALT     (ICON_U8(u8"\uF2EA"))
#define ICON_REFRESH_ALT  (ICON_U8(u8"\uF2F1"))
#define ICON_REDO_ALT     (ICON_U8(u8"\uF2F9"))
#define ICON_SHIELD_ALT   (ICON_U8(u8"\uF3ED"))
#define ICON_BURN         (ICON_U8(u8"\uF46A"))
#define ICON_FEATHER_ALT  (ICON_U8(u8"\uF56B"))
