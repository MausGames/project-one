...
void CoreApp::Setup()
{
    ...
    Core::Manager::Resource->Load<coreModel>  ("ship_boss_messier_high.md3",             CORE_RESOURCE_UPDATE_AUTO,   "data/models/ship_boss_messier_high.md3", CORE_MODEL_LOAD_NO_CLUSTERS);
