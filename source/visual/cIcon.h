...
// TODO 1: optimize this (maybe remove batch-list), it uses quite a lot of CPU (OpenGL), even in release (e.g. separat list for outline and/or no batch for normal rendering) (own super-thick outline shader)
