...
#define DEFAULT_JOYSTICK_MOVE_RIGHT    (0)
    ...
    #define DEFAULT_JOYSTICK_ACTION(n) (((n) == 0u) ? CORE_INPUT_BUTTON_A : (((n) == 1u) ? SDL_GAMEPAD_BUTTON_LEFT_SHOULDER : (((n) == 2u) ? SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER : ((n) == 3u) ? CORE_INPUT_BUTTON_X : ((n) == 4u) ? CORE_INPUT_BUTTON_Y : ((n) == 5u) ? CORE_INPUT_BUTTON_B : ((n) == 6u) ? CORE_INPUT_BUTTON_A : ((n) == 7u) ? SDL_GAMEPAD_BUTTON_START : ((n) == 8u) ? CORE_INPUT_BUTTON_B : INPUT_KEY_INVALID)))
#else
    #define DEFAULT_JOYSTICK_ACTION(n) (((n) == 0u) ? CORE_INPUT_BUTTON_A : (((n) == 1u) ? SDL_GAMEPAD_BUTTON_LEFT_SHOULDER : (((n) == 2u) ? SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER : ((n) == 3u) ? CORE_INPUT_BUTTON_Y : ((n) == 4u) ? CORE_INPUT_BUTTON_X : ((n) == 5u) ? CORE_INPUT_BUTTON_A : ((n) == 6u) ? CORE_INPUT_BUTTON_B : ((n) == 7u) ? SDL_GAMEPAD_BUTTON_START : ((n) == 8u) ? CORE_INPUT_BUTTON_B : INPUT_KEY_INVALID)))
#endif
