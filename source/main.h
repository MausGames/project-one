...
// NOTE: Update Order (C = view change): distortion -C-> glow -C-> (shadow --->) [(water -C->) background] -C-> foreground ---> *
...
#define LIGHT_DIRECTION_FLAT coreVector3(0.442803770f, -0.487084121f, -0.752766371f)   // (LIGHT_DIRECTION * coreVector3(1.0f,1.0f,2.0f)).Normalize()
