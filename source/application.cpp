...
void CoreApp::Setup()
{
    ...
    Core::Manager::Resource->Load<coreShader> ("effect_weather_snow.vert",               CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/effect_weather.vert", PRINT(SHADER_OVERLAYS(%u) SHADER_SINGLE, CORE_GL_SUPPORT(CORE_es2_restriction) ? SNOW_SNOW_NUM_LOW : SNOW_SNOW_NUM));
    Core::Manager::Resource->Load<coreShader> ("effect_weather_snow.frag",               CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/effect_weather.frag", PRINT(SHADER_OVERLAYS(%u) SHADER_SINGLE, CORE_GL_SUPPORT(CORE_es2_restriction) ? SNOW_SNOW_NUM_LOW : SNOW_SNOW_NUM));
    ...
    Core::Manager::Resource->Load<coreShader> ("menu_free.vert",                         CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/menu_free.vert");
    ...
    Core::Manager::Resource->Load<coreShader> ("menu_segment.vert",                      CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/menu_segment.vert");
    ...
    Core::Manager::Resource->Load<coreShader> ("menu_swipe.vert",                        CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/menu_swipe.vert");
